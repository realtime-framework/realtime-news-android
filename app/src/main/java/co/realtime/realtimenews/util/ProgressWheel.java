...
public class ProgressWheel extends View {
    ...
    private int squareColor = 0xFF5490CC;
    ...
    private void setupBounds() {
        ...
        squareBounds = new RectF(circleInnerContour.left + (rimWidth / 2.0f) + (contourSize / 2.0f) + paddingLeft,
                circleInnerContour.top + (rimWidth / 2.0f) + (contourSize / 2.0f) + paddingTop,
                circleInnerContour.right - (rimWidth / 2.0f) - (contourSize / 2.0f) - paddingRight,
                circleInnerContour.bottom - (rimWidth / 2.0f) - (contourSize / 2.0f) - paddingBottom);
